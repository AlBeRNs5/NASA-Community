...
client.user.setGame(`This Bot For Virgina Role Play`,"https://www.twitch.tv/dggamingbot")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
const config = { prefix: "*", token: "NTM5MDkyNDM4Mzg0NTA4OTI4.Dz21GQ.OfwEfHnaPoMVuN81S0YlfIqV63s" };
const tpoints = {};
const vpoints = {};
hero.config = config;
